...
### Task 1: Map `imageView` lifecycle events
...
**Interfaces:**
- Produces: existing `MappedCodexNotification` tool events with `kind: "image_view"`.
...
- [ ] **Step 3: Implement phase-derived tool status and image mapping**
...
- [ ] **Step 3: Implement local-image parsing and ordered rendering**
...
- [ ] **Step 3: Implement upload and card composition**
...
- [ ] **Step 4: Run client and focused integration tests**
...
- [ ] **Step 6: Commit, restart, and test in Feishu**

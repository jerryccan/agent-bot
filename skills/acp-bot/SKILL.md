---
name: acp-bot
description: Manage the local acp-bot service and its Codex or ACP sessions through the acp-bot CLI. Use when a user asks to inspect, start, safely restart, immediately restart, or stop acp-bot; open its console UI; list, inspect, stop, or rename tasks; check a scheduled restart; or troubleshoot the bot without manually killing worker processes.
---
